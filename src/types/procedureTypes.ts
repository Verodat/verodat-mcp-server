...
export interface Procedure {
  ...
  triggers: {
    ...
    operations: string[];
    conditions: string[];
    enforceOnRead?: boolean;  // Optional: explicitly require procedure for READ operations
  };
...
export interface VerodatProcedure {
  ...
  risk_level: string;
  procedures_protocols: string; // JSON string
  created_at: string;
  updated_at: string;
  author: string;
  tags: string;
...
export interface ProcedureConfig {
  ...
  enforcement: {
    ...
    requireForWrite?: boolean;  // Require procedures for WRITE operations
    requireForRead?: boolean;   // Require procedures for READ operations
  };
  verodat: {
    datasetName: string;
