...
export class StartProcedureHandler {
   ...
   */
  static async handleStartProcedure(args: any) {
    try {
   ...
   */
  static async handleListProcedures(args: any) {
    try {
   ...
   */
  static async handleResumeProcedure(args: any) {
    try {
   ...
   */
  static async checkProcedureRequirement(toolName: string, operation?: string) {
